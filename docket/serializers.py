...
class CaseCreateSerializer(serializers.ModelSerializer):
    ...
    totalPayments = serializers.DecimalField(max_digits=20, decimal_places=10)
    accruedInterest = serializers.DecimalField(max_digits=20, decimal_places=10)
    principalBalance = serializers.DecimalField(max_digits=20, decimal_places=10)
    payoffAmount = serializers.DecimalField(max_digits=20, decimal_places=10)
    interestRate = serializers.DecimalField(max_digits=10, decimal_places=6)
